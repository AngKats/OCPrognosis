function [validationAccuracy, validationPredictions] = trainSVMquadr_2(trainingData, NoFolds, predictorNames)
% Usage 
%  [validationAccuracy, validationPredictions] = trainSVMquadr_2(trainingData, NoFolds, predictorNames)
%
%  Input:
