 function  [validationAccuracy, validationPredictions] = trainSVMcubic(trainingData, NoFolds, predictorNames)
% Usage 
%      [validationAccuracy, validationPredictions] = trainSVMcubic(trainingData, NoFolds, predictorNames)
%
%  Input:
...
partitionedModel = crossval(trainedClassifier.ClassificationSVM, 'KFold', NoFolds);
