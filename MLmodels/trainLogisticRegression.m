function [validationAccuracy, validationPredictions] = trainLogisticRegression(trainingData, NoFolds,predictorNames)
% Usage 
%  [validationAccuracy, validationPredictions] = trainLogisticRegression(trainingData, NoFolds,predictorNames)
%
%  Input:
...
% Train a classifier: the response values must be converted to zeros
...
%KFolds = 10;
cvp = cvpartition(response, 'KFold', NoFolds);
