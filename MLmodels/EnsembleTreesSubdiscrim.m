function [validationAccuracy, validationPredictions] = EnsembleTreesSubdiscrim(trainingData, NoFolds, predictorNames)
% Usage 
%  [validationAccuracy, validationPredictions] = EnsembleTreesSubdiscrim(trainingData, NoFolds, predictorNames)
%
%  Input:
...
%      predictorNames: The names of the pre-selected features
%      
%  Output:
...
% Train a classifier: classifier options
subspaceDimension = max(1, min(5, width(predictors) - 1));
